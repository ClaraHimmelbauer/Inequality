    ...
    \begin{columns}
        \begin{column}{.3\textwidth}
            \begin{block}{Absolute Armutsbetroffenheit}
                \begin{itemize}
                    \item Extreme Armutsschwelle: weniger als \$$2,15$ pro Person und Tag (in Kaufkraftparitäten)
                    \item Armutsschwelle: \$$3,65$ pro Person/Tag
...
\begin{frame}{Armut}
    ...
    Armutsbetroffenheit global, national
    Wie wird Armut gemessen? Was haben sie gesagt ist relevant?
\end{frame}
