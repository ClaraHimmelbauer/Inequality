...
\begin{frame}[label = was-ist-gerecht]{Was ist gerecht?}
    ...
    \begin{itemize}
        ...
        \item Historische Entwicklung von Ungleichheit \hyperlink{within-between-ineq}{\beamerskipbutton{Within- \& between-country inequality }}
    \end{itemize}
...
\begin{frame}[label = timeline-income]{Entwicklung globale Einkommensverteilung}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\linewidth]{figur}
